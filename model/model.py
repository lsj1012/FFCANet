...
from model.ca import CoordAtt
from model.fcanet import MultiSpectralAttentionLayer
# from model.tsformer import CrissCrossAttention
# from model.sgff import InjectionMultiSum
from model.eca import ECAAttention
import numpy as np
...
class parsingNet(torch.nn.Module):
    def __init__(self, size=(288, 800), pretrained=True, backbone='50', cls_dim=(37, 10, 4), use_aux=False):
        ...
        self.ca = CoordAtt(inp=512, oup=512)
        self.fcanet = MultiSpectralAttentionLayer(channel=512, dct_h=16, dct_w=16)
        ...
        # self.pool1 = torch.nn.Conv2d(128, 384, 1) if backbone in ['34', '18'] else torch.nn.Conv2d(128, 384, 1)
